...
- 修复 QQ 音乐微信扫码登录后，点击同步仍提示未检测到有效登录的问题。
- 修复 URL 导入落雪音源脚本失败的问题，并完善导入音源的播放解析。
- 修复汽水音乐无效 Cookie 被误判为已登录，以及切换账号后会员标识可能残留的问题。
...
本应用为第三方开源音乐客户端，仅供个人学习交流使用，并非网易云音乐、QQ 音乐、酷狗音乐或汽水音乐官方软件。音乐版权归相应版权方所有，请遵守各平台服务条款并支持正版。
